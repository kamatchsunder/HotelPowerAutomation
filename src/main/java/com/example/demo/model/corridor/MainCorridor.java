...
import static com.example.demo.constants.Constants.defaultAcStatusInMainCorridor;
import static com.example.demo.constants.Constants.defaultLightStatusInMainCorridor;
import static com.example.demo.constants.Constants.defaultNumberOfAcsPerMainCorridor;
import static com.example.demo.constants.Constants.defaultNumberOfLightsPerMainCorridor;


public class MainCorridor extends Corridor implements CorridorElement {
    ...
    private PowerStatus defaultLightPowerStatus = defaultLightStatusInMainCorridor;
    private PowerStatus defaultAcPowerStatus = defaultAcStatusInMainCorridor;
    ...
    private void initAcs() {
        ...
        for (int i = 0; i < defaultNumberOfAcsPerMainCorridor ; i++) {
    ...
    private void initLights() {
        ...
        for (int i = 0; i < defaultNumberOfLightsPerMainCorridor ; i++) {
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof MainCorridor) {

            MainCorridor corridor = (MainCorridor) object;
